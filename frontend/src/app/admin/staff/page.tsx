...
export default function StaffManagementPage() {
    ...
    return (
        <div className="space-y-10 pb-20 max-w-[1600px] mx-auto px-4 md:px-0">
            ...
            {/* Provisioning Modal */}
            {showAddModal && (
                <div className="fixed inset-0 bg-black/90 backdrop-blur-2xl z-[1000] overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 py-8 md:py-12">
                        <div className="bg-[#1A1A1A] border border-premium-gold/30 w-full max-w-2xl shadow-[0_0_100px_rgba(234,179,8,0.15)] animate-in zoom-in-95 duration-500 relative mt-10 mb-10">
                            ...
                            <div className="p-12 border-b border-white/5 flex justify-between items-center bg-premium-gold/5 relative">
                                ...
                                <button onClick={() => setShowAddModal(false)} className="w-14 h-14 bg-white/5 hover:bg-rose-600 hover:text-white border border-white/10 hover:border-rose-600 text-white/50 transition-all font-bold flex items-center justify-center">
                                    <FiX size={24} />
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleAddAdmin} className="p-12 space-y-10">
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div className={`grid gap-4 ${currentUser?.role === 'super_admin' ? 'grid-cols-3' : 'grid-cols-2'}`}>
                                            <button
                                                type="button"
                                            ...
                                            {currentUser?.role === 'super_admin' && (
                                                <button
                                                    ...
                                                    className={`py-5 border font-black uppercase text-[10px] tracking-[0.3em] transition-all duration-500 ${formData.role === 'super_admin' ? 'bg-rose-500/20 text-rose-400 border-rose-500/50 shadow-[0_0_30px_rgba(244,63,94,0.2)]' : 'bg-transparent text-white/20 border-white/10 hover:border-rose-400/40 hover:text-white/60'}`}
                                                >
                                                    Supreme (Super)
                                                </button>
                                            )}
