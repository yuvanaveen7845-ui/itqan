    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg p-12 mb-8 shadow-xl relative overflow-hidden">
        <div className="relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Premium Textile Collection</h1>
          <p className="text-xl mb-6">Discover the finest fabrics for every occasion. Quality guaranteed.</p>
      ...
      <section className="bg-red-50 border border-red-200 text-red-800 rounded-lg p-6 mb-12 flex justify-between items-center shadow-sm">
        <div>
          ...
          <p>Get up to 40% off on all premium silk fabrics.</p>
        </div>
        <Link href="/products?fabric_type=Silk" className="bg-red-600 text-white px-6 py-2 rounded font-bold hover:bg-red-700 transition">
          Claim Offer
        </Link>
      </section>
      ...
      {/* Trending Fabrics - Horizontal Scroll or Grid */}
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
          {['Cotton', 'Silk', 'Linen', 'Wool', 'Perfume'].map((category) => (
            <Link key={category} href={`/products?fabric_type=${category}`}>
      ...
      <section className="mb-16 bg-blue-900 text-white rounded-xl p-8 md:p-12 shadow-inner">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { id: 1, name: "Sarah J.", role: "Fashion Designer", text: "The quality of the silk fabrics here is unmatched. I source all my premium materials from this store.", rating: 5 },
            { id: 2, name: "Michael T.", role: "Boutique Owner", text: "Incredible selection and fast shipping. The detailed product descriptions make ordering online risk-free.", rating: 5 },
            { id: 3, name: "Priya R.", role: "Customer", text: "I bought the premium cotton for a summer dress. The fabric is breathable, vibrant, and exactly as pictured.", rating: 4 }
          ].map(review => (
      ...
      <section className="bg-gray-100 rounded-xl p-12 text-center border border-gray-200">
        ...
        <p className="text-gray-600 mb-8 max-w-xl mx-auto">Join our community to get exclusive access to new fabric collections, early access to sales, and textile care tips.</p>
